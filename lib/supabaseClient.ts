...
export async function dumpDummyLeaderboardEntries() {
    const entries: LeaderboardEntry[] = [
        // Broke entries
        { category: 'broke', fid: 5650, wallet_address: '0xBroke1', username: 'user1', score: 10, comment: 'Broke - just starting out' },
        { category: 'broke', fid: 5650, wallet_address: '0xBroke2', username: 'user2', score: 15, comment: 'Broke but learning' },
        { category: 'broke', fid: 5650, wallet_address: '0xBroke3', username: 'user3', score: 20, comment: 'Broke and budgeting' },

        // Degen entries
        { category: 'degen', fid: 5650, wallet_address: '0xDegen1', username: 'user4', score: 30, comment: 'Degen - high risk, high reward' },
        { category: 'degen', fid: 5650, wallet_address: '0xDegen2', username: 'user5', score: 35, comment: 'Degen, no regrets' },
        { category: 'degen', fid: 5650, wallet_address: '0xDegen3', username: 'user6', score: 40, comment: 'Degen, on a roll' },

        // Bluechip entries
        { category: 'bluechip', fid: 5650, wallet_address: '0xBluechip1', username: 'user7', score: 50, comment: 'Bluechip, steady growth' },
        { category: 'bluechip', fid: 5650, wallet_address: '0xBluechip2', username: 'user8', score: 55, comment: 'Bluechip, reliable' },
        { category: 'bluechip', fid: 5650, wallet_address: '0xBluechip3', username: 'user9', score: 60, comment: 'Bluechip, long-term vision' },

        // Additional entries to make a dozen
        { category: 'broke', fid: 5650, wallet_address: '0xBroke4', username: 'user10', score: 12, comment: 'Broke, but optimistic' },
        { category: 'degen', fid: 5650, wallet_address: '0xDegen4', username: 'user11', score: 42, comment: 'Degen, playing smart' },
        { category: 'bluechip', fid: 5650, wallet_address: '0xBluechip4', username: 'user12', score: 62, comment: 'Bluechip, consistent performer' },
    ];
