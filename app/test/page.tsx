...
export default function Home() {
    ...
    async function getPerplexity(message: string) {
    ...
    async function getSummary(message: string) {
        const context = "You are a helpful assistant that summarizes messages. You will be given an array of messages, there is a user interested in cryptocurrency and you need to summarize the messages in a way that succinctly lets them know what people are discussing"
        const response = await fetch("/api/chatgpt", {
            method: "POST",
            headers: {
